...
TextStyle boldTextStyle = const TextStyle(fontSize: 19, color: Colors.black);
TextStyle vboldTextStyle = const TextStyle(fontSize: 24, color: Colors.black);
...
TextStyle thinRedColorTextStyle =
    const TextStyle(fontSize: 16, color: Colors.redAccent);
Widget hSizedBox = const SizedBox(
  height: 10,
);
